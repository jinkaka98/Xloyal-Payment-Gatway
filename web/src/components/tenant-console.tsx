...
type TenantAPI = { id: string; merchant_id?: string; name: string; site_url?: string; callback_url?: string; webhook_url?: string; sandbox_mode: boolean; use_unique_amount_code?: boolean; active: boolean; api_key_recoverable?: boolean; created_at: string };
