...
const staticFixture = "00020101021126570011ID.DANA.WWW011893600915303088327702090308832770303UMI51440014ID.CO.QRIS.WWW0215ID10265298200310303UMI5204504553033605802ID5915XLOYAL MERCHANT6014BANDAR LAMPUNG610565164630448AD"
...
func TestConvertRejectsInvalidAndNonStatic(t *testing.T) {
	invalidCRC := staticFixture[:len(staticFixture)-1] + "0"
	if _, err := Convert(invalidCRC, 50000); err == nil {
